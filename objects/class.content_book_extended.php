...
class content_book_extended extends content_book implements icontent {
	...
	public function GetItemsBySection($section, $count = false, $limit = null) {
		if ($count) {
			...
			$select = "select c.content_bookid as id, c.title as title, c.buy_price as price, c.overview as overview, c.review_points_users as rating, c.view_count as view_count, c.created as created";
		}
