...
$configuration['setup_password'] = 'postgres';
...
$configuration['db']	= "rhovit"; 		//	database name
$configuration['host']	= "localhost";	//	database host
$configuration['user']	= "root";		//	database user
$configuration['pass']	= "postgres";		//	database password
...
//plugin settings
$configuration['plugins_path'] = $_SERVER["DOCUMENT_ROOT"].'/plugins/';  //absolute path to plugins folder, e.g c:/mycode/test/plugins or /home/phpobj/public_html/plugins
