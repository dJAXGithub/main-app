...
<div class="contentCenterTitle cleft">
  ...
  <div class="city_select">
	<select name="cmb_section_city" id="cmb_section_city" onchange="changeSectionCity('<?php echo SITE_URL; ?>', this.value, '<?php echo $content_manager->content_type; ?>', <?php echo $content_manager->section_items_to_show; ?>, '<?php echo $content_manager->shadow_title; ?>', '<?php echo $content_manager->jcarousel_tango_skin; ?>')">
<?php
